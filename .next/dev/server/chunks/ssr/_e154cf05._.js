...
function ContactsPage() {
    ...
    const loadContacts = async ()=>{
        try {
            ...
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseJsonResponse"])(response);
            setContacts(data);
        } catch (error) {
    ...
    const handleSave = async (contactData)=>{
        try {
            if (editingContact) {
                ...
                const newContact = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseJsonResponse"])(response);
                setContacts([
                    ...contacts,
                    newContact
                ]);
